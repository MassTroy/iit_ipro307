...
public class PersistenceConfig {
	public static final String COMPONENT_SCAN = "iit.ipro307.persistence";
	public static final String PROPERTIES_FILE = "ipro307-hibernate.properties";
	public static final String ENTITIES_SCAN = "iit.ipro307.persistence";
